...
import { faEnvelope, faMagnifyingGlass, faCartShopping, faTimes, faBars } from '@fortawesome/free-solid-svg-icons'
            ...
            <div className="container mx-auto flex justify-between items-center">
                ...
                <nav className="hidden md:flex ">
                    ...
                    <select onChange={handleSelectChange} defaultValue="" className='  ml-4 bg-transparent md:text-lg text-white hover:text-yellow-300'>
                        <option value="" className='w-6 text-black hover:scale-105 ' desabled  >Nav Menu</option>
